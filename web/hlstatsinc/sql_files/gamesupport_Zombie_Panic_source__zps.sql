...
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'arms', 'Armed and Dangerous', 'kills with Zombie Arms');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'carrierarms', 'Carry on...', 'kills with Carrier Arms');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'ak47', 'AK-47', 'kills with AK-47');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'mp5', 'MP5', 'kills with MP5');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'revolver', 'Revolver', 'kills with Revolver');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'glock', 'Glock 17', 'kills with Glock 17');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'glock18c', 'Glock 18c', 'kills with Glock 18c');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'ppk', 'PPK', 'kills with PPK');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'usp', 'H & K USP', 'kills with H & K USP');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', '870', 'Rem. 870', 'kills with Rem. 870');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'supershorty', 'Super Shorty', 'kills with Super Shorty');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'grenade_frag', 'Grenade', 'kills with Grenades');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'sledgehammer', 'Sledgehammer', 'kills with Sledgehammer');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'crowbar', 'Hello, I''m Gordon Freeman', 'kills with Crowbar');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'chair', 'Sorry, I thought this was pro wrestling', 'kills with Chair');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'keyboard', 'Keyboard', 'kills with Keyboard');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'plank', 'Plank', 'kills with Plank');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'shovel', 'Grave Digger', 'kills with Shovel');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'golf', 'Fore!', 'kills with Golf Club');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'machete', 'Cuttin'' em Down', 'kills with Machete');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'fryingpan', 'Frying Pan', 'kills with Frying Pan');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'spanner', 'Wrench', 'kills with Wrench');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'axe', 'Axe', 'kills with Axe');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'tireiron', 'Tire Iron', 'kills with Tire Iron');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'hammer', 'Hammer', 'kills with Hammer');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'broom', 'Broom', 'kills with Broom');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'pot', 'Pot', 'kills with Pot');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'racket', 'Tennis Racket', 'kills with Tennis Racket');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'latency','Best Latency','ms average connection');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'bat_aluminum','Out of the park!','kills with Bat (Aluminum)');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'bat_wood','Corked','kills with Bat (Wood)');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'm4','M4','kills with M4');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'pipe','Piping hot','kills with Pipe');
INSERT IGNORE INTO `++DB_PREFIX++_Awards` VALUES ('W', 'zps', 'slam','IEDs','kills with IED');
